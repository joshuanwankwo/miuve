    ...
    <>
      ...
      {value ? (
        ...
        <button
          ...
          className=" z-10 mt-6 flex max-w-fit items-center justify-center space-x-2 rounded-full border bg-[#1ED660] px-5 py-2 text-sm text-white shadow-s transition-colors hover:border-green-200 hover:bg-white hover:text-black  "
        >
          <p>Start Renting!</p>
        </button>
      )}
